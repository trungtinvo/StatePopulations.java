    ...
    public static void main(String[] args) throws IOException {
        ...
        for (i = 0; i < zipCodeState.size(); ++i) {
            ...
            if (myZipCode == zipCodeState.get(i).getValue1()) {
                myStateAbbreviation = zipCodeState.get(i).getValue2();
                break;
            }
        }
        ...
        for (i = 0; i < abbrevState.size(); ++i) {
            ...
            if (myStateAbbreviation.compareTo(abbrevState.get(i).getValue1()) == 0) {
        ...
        for (i = 0; i < statePopulation.size(); ++i) {
            ...
            if (myStateName.compareTo(statePopulation.get(i).getValue1()) == 0) {
